...
async function detectUserLanguage() {
    ...
    try {
        ...
        const prefered_language_code = localStorage.getItem('ReSuSFSLanguage');
        ...
        if (prefered_language_code !== 'default' && availableLanguages.includes(prefered_language_code)) {
            ...
            localStorage.removeItem('ReSuSFSLanguage');
            return 'en';
        }
    } catch (error) {
...
function setLanguage(language) {
    localStorage.setItem('ReSuSFSLanguage', language);
...
async function generateLanguageMenu() {
    ...
    const createOption = (lang, name) => {
        ...
        const currentLang = localStorage.getItem('ReSuSFSLanguage') || 'default';
        if (currentLang === lang) {
            radio.checked = true;
        }
